...
namespace BakeryAPI.Repositories
{
    ...
    public interface IProductRepository
    {
        ...
        Task<IEnumerable<Product>> Get(ProductFilterType filterType, bool descending);  //get products sorted by filter (while bool variable true sort in descending order)
